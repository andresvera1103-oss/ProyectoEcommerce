        ...
        <div className="flex-1 flex flex-col justify-between min-w-0">
          ...
          <div className="flex items-center justify-between mt-3">
            <div className="flex-1 flex justify-center">
              <div className="flex items-center border border-slate-200 dark:border-slate-700 rounded-md bg-white dark:bg-slate-900 h-8 shadow-sm">
                <Button 
                  variant="ghost" size="icon" className="h-full w-8 rounded-none rounded-l-md hover:bg-slate-50 dark:hover:bg-slate-800"
                ...
                <Button 
                  variant="ghost" size="icon" className="h-full w-8 rounded-none rounded-r-md hover:bg-slate-50 dark:hover:bg-slate-800"
