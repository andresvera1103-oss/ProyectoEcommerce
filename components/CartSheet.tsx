  ...
  return (
    <div>
      <div className="flex gap-4 py-3">
        ...
        {/* Contenedor de la imagen con más espacio a la derecha (pr-6) y la línea divisoria */}
        <div className="relative h-28 w-28 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden flex-shrink-0 pr-6">
          ...
          {/* Línea divisoria dentro del recuadro, pegada a la derecha */}
          <div className="absolute top-0 bottom-0 right-0 w-px bg-slate-200 dark:bg-slate-700 h-full"></div>
        </div>
